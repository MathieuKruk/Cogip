...
<p>Projet d'un site dynamique mettant en relation un base de données avec des tableaux HTML.
Le tout cherchant à amener des informations demandées par un tiers via une interface simple et efficace.</p>
